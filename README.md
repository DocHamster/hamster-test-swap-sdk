...
```sh
git clone https://github.com/hamster-test-swapswap/hamster-test-swap-sdk.git
```

Move into the hamster-test-swap-sdk working directory

```sh
cd hamster-test-swap-sdk/
```
